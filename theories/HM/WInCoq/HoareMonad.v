...
| occ_fail  : forall v t, t <> var v -> occurs v t -> UnifyFailure (var v) t
| occ_fail'  : forall v t, t <> var v -> occurs v t -> UnifyFailure t (var v)
...
| UnifyRejected' : ty -> ty -> InferFailure
